...
export default function Footer(props){
    ...
    let pattern = /^[(\w\d\W)+]+@[\w+]+\.[\w+]+$/i;

    // form submision state

    const[mailvalidity, setMailValidity] = React.useState(true);

    function validate (event){
        event.preventDefault();
       const isValid = pattern.test(mailData.mail);
       setMailValidity(isValid);
    }
   
    return(
        <footer>

            <div className="footerlogo-social">
            ...
            <div className="footer-nav">
                ...
                <button>{props.products}</button>
                <button>{props.about}</button>
            </div>

            <div className="policy">
                <button>{props.carrers}</button>
                <button>{props.policy}</button>
                <button>{props.privacy}</button>
            ...
            <div className="form-container">
                ...
                <form action="">
                    ...
                    <span className={`errormessage ${mailvalidity ? "" : "error"}`} >please entenr a valid mail</span>
                </form>
            ...
            <span id="right"> Copyright 2020. All Rights Reserved</span>

            <div className="attribution-container">
                <p className="attribution">
                    Challenge by <a href="https://www.frontendmentor.io?ref=challenge" target="_blank">Frontend Mentor</a>. Coded by <a href="#">Olasunkanmi Oluwatimileyin</a>.
                </p> 
            </div>
